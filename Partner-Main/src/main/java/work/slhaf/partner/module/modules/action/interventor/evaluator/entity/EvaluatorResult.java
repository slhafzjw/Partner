...
import lombok.Data;
import work.slhaf.partner.module.modules.action.interventor.handler.entity.InterventionType;
...
public class EvaluatorResult {
     ...
     */
    private boolean ok;
    private List<EvaluatedInterventionData> dataList = new ArrayList<>();
